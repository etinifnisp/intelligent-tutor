...
import { API, masteryColor, subjectColor } from '../utils.jsx';
...
export default function GraphPage({ sessionId }) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      fetch(`${API}/stats/${sessionId}`).then(r => r.json()).catch(() => ({ mastery: {}, chapter_mastery: {} })),
    ]).then(([gData, mData]) => {
  ...
  return (
    <div id="page-graph" className="page active">
      ...
      <div className="graph-controls">
        <span className="graph-title">Concept Knowledge Graph</span>
